...
Generate semantic IDs from trained ADSA model and analyze:
...
from ADSA import ADSA
from multimodal_dataset import ADSADataset


class SemanticIDGenerator:
    """Generate and analyze semantic IDs from trained ADSA"""
    ...
    def load_dataset(self):
        ...
        from HID_VAE import create_adsa_from_config
        self.model = create_adsa_from_config(
            config=self.config,
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Generate and analyze semantic IDs from trained ADSA'
    )
