"""
ADSA: Hierarchical ID VAE with IDE + UPR + SACO
...
class ADSA(nn.Module):
    """
    ADSA with IDE + UPR + optional Dual-Head Decoder.
...
def create_adsa_from_config(config: Dict) -> ADSA:
    """Factory function to create ADSA from configuration dictionary."""
    return ADSA(
