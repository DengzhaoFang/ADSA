...
DATASET_CONFIGS = {
    'beauty': {
        ...
        'checkpoints': {
            ...
            'Adsa': 'scripts/output/recommender/adsa/beauty/2026-01-06-21-58-26_3layer-adsa/best_model.pt',
    ...
    'cds': {
        ...
        'checkpoints': {
            ...
            'Adsa': 'scripts/output/recommender/adsa/cds/2025-12-29-01-59-37_3layer-adsa-tile/best_model.pt',
...
def benchmark_inference(
    ...
    # Check if Adsa needs multimodal inputs
    use_multimodal = False
    if model_name == 'Adsa' and config:
        training_config = config.get('training', None)
        if training_config and training_config.use_multimodal_fusion:
            use_multimodal = True
            logger.info("  Using multimodal inputs for Adsa")
    ...
    if model_name == 'ActionPiece':
        ...
        for sample in samples:
            ...
            # Prepare multimodal inputs for Adsa
            if use_multimodal:
...
def plot_multi_dataset_efficiency(
    ...
    libertine_font_dir = '/home//Fonts/libertine/opentype'
    libertine_fonts = [
    ...
    model_colors = {
        ...
        'ADSA': '#8172B3',       # Soft purple (our method - distinctive)
    }
    
    # Define desired order: generative models only (exclude SASRec)
    desired_order = ['TIGER', 'LETTER', 'ActionPiece', 'EAGER', 'ADSA']
...
def parse_args():
    ...
    parser.add_argument('--models', type=str, nargs='+',
                       default=['TIGER', 'LETTER', 'ActionPiece', 'EAGER', 'Adsa', 'SASRec'],
...
def benchmark_dataset(
    ...
    for model_name in models:
        ...
        if model_name == 'SASRec':
            try:
                from src.recommender.adsa.sasrec_simulator import create_sasrec_simulator
        ...
        # Handle generative models
            ...
            try:
                ...
                # Load purified multimodal embeddings for Adsa
