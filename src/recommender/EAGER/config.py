...
def get_beauty_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'behavior_emb_path': "dataset/Amazon-Beauty/processed/beauty-adsa-sentenceT5base/Beauty/lightgcn/item_embeddings_collab.npy",
...
def get_sports_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        'behavior_emb_path': "dataset/Amazon-Sports/processed/sports-adsa-sentenceT5base/Sports/lightgcn/item_embeddings_collab.npy",
...
def get_toys_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        # GCT embedding paths for EAGER (if using dual-stream mode)
        'behavior_emb_path': "dataset/Amazon-Toys/processed/toys-adsa-sentenceT5base/Toys/lightgcn/item_embeddings_collab.npy",
...
def get_cds_config(
    ...
    **kwargs
    ...
    default_paths = {
        ...
        # GCT embedding paths for EAGER (if using dual-stream mode)
        'behavior_emb_path': "dataset/Amazon-CDs/processed/cds-adsa-sentenceT5base/CDs/lightgcn/item_embeddings_collab.npy",
