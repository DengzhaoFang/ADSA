...
DATA_PATH="${DATA_PATH:-dataset/Amazon-Books/processed/books-adsa-sentenceT5base/Books}"
OUTPUT_DIR="${OUTPUT_DIR:-scripts/output/adsa_tokenizer/books/pasa_default}"
DEVICE="${DEVICE:-cuda}"
