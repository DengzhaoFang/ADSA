...
# ADSA Stage 1 tokenizer training for Amazon Toys.
# Run from anywhere:
...
DATA_PATH="${DATA_PATH:-dataset/Amazon-Toys/processed/toys-adsa-sentenceT5base/Toys}"
OUTPUT_DIR="${OUTPUT_DIR:-scripts/output/adsa_tokenizer/toys/hparam_stage1_PASCL/pasa_default}"
DEVICE="${DEVICE:-cuda}"
