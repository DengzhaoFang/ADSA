...
# ADSA Training Script with Similarity-First Curriculum Strategy
# 
...
cd ../../src/sid_tokenizer/adsa

python train_adsa.py \
    --data_path ../../../dataset/Amazon-Sports/processed/sports-adsa-sentenceT5base/Sports \
    --output_dir ../../../scripts/output/adsa_tokenizer/sports/3-256-32-ema-only-5-core-items  \
    \
    --n_layers 3 \
